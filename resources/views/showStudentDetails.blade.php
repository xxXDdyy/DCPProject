            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="card-header text-white py-4 px-4 border-0"
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                        <div>
                            <h2 class="mb-1 fw-bold">Student Details</h2>
                            <p class="mb-0 opacity-75">
                                View the complete information of the selected student record.
                            </p>
                        </div>

                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.students.edit', $student->id) }}" class="btn btn-light rounded-pill px-4">
                                Edit
                            </a>
                            <a href="{{ route('admin.students.index') }}" class="btn btn-outline-light rounded-pill px-4">
                                Back
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="border rounded-4 p-3 bg-light h-100">
                                ...
                                <div class="fw-semibold fs-5">{{ $student->id }}</div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="border rounded-4 p-3 bg-light h-100">
                                ...
                                <div class="fw-semibold fs-5">{{ $student->email }}</div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="border rounded-4 p-3 h-100">
                                ...
                                <div class="fw-semibold">{{ $student->contact_no }}</div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="border rounded-4 p-3 h-100">
                                ...
                                <div class="fw-semibold">{{ $student->degree->degree ?? 'N/A' }}</div>
                            </div>
                        </div>
                    </div>

                    <div class="mt-4 d-flex flex-column flex-sm-row gap-2 justify-content-end">
                        <a href="{{ route('admin.students.index') }}" class="btn btn-light border rounded-pill px-4">
                            Back to List
                        </a>
                        <a href="{{ route('admin.students.edit', $student->id) }}" class="btn btn-primary rounded-pill px-4 shadow-sm">
                            Edit Student
                        </a>
                    </div>
                </div>
