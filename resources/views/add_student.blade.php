        ...
        <div class="col-lg-7 col-md-9 col-12">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="card-header text-white py-4 px-4 border-0"
                    ...
                    <h2 class="mb-1 fw-bold">Add New Student</h2>
                    <p class="mb-0 opacity-75">
                        Fill in the student information below to create a new record.
                    </p>
                </div>
                    ...
                    <div class="js-ajax-fields">
                            ...
                            <div class="col-12">
                                ...
                                >
                                    ...
                                    @foreach($degrees as $degree)
                                        <option value="{{ $degree->degree_id }}" {{ old('degree_id') == $degree->degree_id ? 'selected' : '' }}>
                                            {{ $degree->degree }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-end mt-4">
                            ...
                            <button
                                ...
                                data-url="{{ route('admin.students.store') }}"
                                data-method="POST"
