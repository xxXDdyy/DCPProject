        ...
        <div class="col-lg-7 col-md-9 col-12">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                <div class="card-header text-white py-4 px-4 border-0"
                    ...
                    <h2 class="mb-1 fw-bold">Edit Teacher</h2>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="js-ajax-fields">
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-end mt-4">
                            <a href="{{ route('admin.teachers.show', $teacher->id) }}" class="btn btn-light border rounded-pill px-4">
                                Cancel
                            </a>
                            <button
                                type="button"
                                ...
                                data-method="PUT"
                                data-redirect="{{ route('admin.teachers.show', $teacher->id) }}"
                            >
                                Update Teacher
                            </button>
                        </div>
